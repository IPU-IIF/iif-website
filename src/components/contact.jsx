...
const EmailSection = () => {
  ...
  return (
    <>
      <h2 className="mt-8 text-center font-bold text-4xl" id="contactus">
        Contact Us
      </h2>
      <section className="grid md:grid-cols-2 my-2 md:my-4 py-8 gap-4 relative">
        ...
        "
            ...
            <button
              type="submit"
              className="bg-[#F69E19] hover:bg-[#f69e19d9] text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
