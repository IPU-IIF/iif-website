...
const Overview = () => {
    return (
        <div id='about' className="scroll-m-28 scroll-smooth w-full flex flex-col items-center justify-center bg-gradient-to-b from-[#f79f1a] to-[#f79f1a] h-[335px] text-gray px-4 md:px-6 lg:px-8">
