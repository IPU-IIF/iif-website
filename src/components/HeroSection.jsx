  ...
  return (
    <div className="relative w-full h-[600px]">
      ...
      <div className="relative z-30 flex flex-col items-center justify-center h-full text-center text-white px-4">
        ...
        <p className = "text-3xl md:text-5xl font-bold mb-4">INNOVATION & INCUBATION FOUNDATION</p>
        <p className="  w-[1190px] h-[24px]  text-[#f4f4f4] text-2xl font-bold font-['Helvetica'] leading-7">
          Empowering the transformation of Innovative concepts into Tangible Results
        </p>
        
        {/* Action Button */}
        <button className="bg-[#F4A300] text-white text-2xl font-bold font-['Helvetica']leading-7 md:text-l px-10 py-3 w-[511px] h-[58px] rounded-[10px] hover:bg-[#f49800] focus:outline-none focus:ring-2 focus:ring-[#F4A300] focus:ring-opacity-50 mt-32    ">
          Pitch Us
        </button>
